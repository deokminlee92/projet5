...
//Récupérer le panier(array) du LS//
let cart = JSON.parse(localStorage.getItem("getAddedToCart"));

function parcourirPanier(){
    if (cart != null){
        //Création des éléments dans la paga Panier//
            let affichageProductOption = {
                id : cart.id,
